...
export default function HeroDoubleReverse({cidade}: Props) {
    return (
        <section className="bg-blue-700 dark:bg-gray-900">
            ...
            <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
                ...
                <div className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                    <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-white dark:text-white">Impulsione Seu Negócio com Soluções de Ventilação Eficientes em {cidade}!</h2>
                    <p className="mb-4 text-white">"A eficiência operacional é essencial para o sucesso de qualquer negócio. Pensando nisso, a Fabricalhas {cidade} apresenta sua linha de exaustores eólicos, a solução definitiva para ventilação industrial. Projetados com tecnologia avançada e materiais de alta qualidade, nossos exaustores otimizam o ambiente de trabalho, garantindo desempenho máximo e economia.
                    </p>
