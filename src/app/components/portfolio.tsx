    ...
    return (
        <div className="max-w-screen-xl-xl space-y-10 mb-10 p-2 flex flex-col items-center h-auto">
            <div className="flex flex-col items-center space-y-2 w-full mt-6">
                <h1 className="text-2xl md:text-4xl font-semibold text-blue-800">Conheça nosso portifólio</h1>
                ...
                Conheça o amplo portfólio da Fabricalhas, com produtos como calhas, rufos, coifas, curvas, dutos, perfis metálicos e exaustores eólicos. Fabricados com materiais de alta qualidade, nossos itens proporcionam proteção confiável contra intempéries. Com uma equipe especializada, desenvolvemos soluções sob medida para atender às demandas específicas de cada cliente. Confie na Fabricalhas para garantir a proteção e durabilidade da sua propriedade!
                </p>
            </div>
